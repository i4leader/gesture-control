    ...
    this.element.innerHTML = `
      <div class="landing-container">
        <header class="landing-header">
          <h1 class="app-title">手势实验室</h1>
          <p class="app-subtitle">非接触式交互体验</p>
        </header>
        
        <div class="portals-container">
          <button class="portal-card galaxy-portal" data-mode="particle">
            <div class="portal-content">
              <h2 class="portal-title">启动控制器</h2>
              <p class="portal-desc">使用手势控制粒子文字与特效</p>
            </div>
            <div class="portal-footer">
              <span class="key-hint">点击开始</span>
            </div>
