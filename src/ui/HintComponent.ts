    ...
    if (mode === 'galaxy') {
      content.innerHTML = `
        <div class="hint-header">
          <span class="hint-title">操作指南</span>
        </div>
        <div class="hint-list">
          <div class="hint-item">伸出双手生成星系</div>
          <div class="hint-item">双手张开放大</div>
          <div class="hint-item">双手合拢缩小</div>
          <div class="hint-item">握拳触发大爆炸</div>
          <div class="hint-item">捏合手指生成恒星</div>
        </div>
      `;
      ...
      content.innerHTML = `
        ...
        <div class="hint-list">
          <div class="hint-item">挥手切割物体得分</div>
          <div class="hint-item">快速挥手产生更大爆炸</div>
          <div class="hint-item">双手展示触发能量束</div>
          <div class="hint-item">按 <kbd>Space</kbd> 暂停/继续</div>
          <div class="hint-item">按 <kbd>R</kbd> 重置</div>
        </div>
      `;
    } else {
      content.innerHTML = `
        ...
        <div class="hint-list">
          <div class="hint-item">挥手擦除雾气</div>
          <div class="hint-item highlight clickable-hint" data-action="reset">
            <span class="desktop-text">按 <kbd>R</kbd> 重置</span>
            <span class="mobile-text">点击重置</span>
          </div>
        </div>
      `;
  ...
  private createDOM(): void {
    ...
    this.element.innerHTML = `
      ...
      <div class="hint-footer">
        <span class="desktop-text">按 <kbd>H</kbd> 切换提示</span>
        <span class="mobile-text">点击切换提示</span>
      </div>
